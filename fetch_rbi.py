"""
Fetch latest RBI press releases and save them to Neon.
...
def main():
    print("=== CruxAffairs: RBI Ingestion ===\n")

    raw_articles = fetch_latest_rbi(limit=10)
    if not raw_articles:
        print("No articles fetched. Check your internet connection or the RBI URL.")
        return
